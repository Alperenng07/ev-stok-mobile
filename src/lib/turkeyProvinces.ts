/** Türkiye illeri (Photon `state` alanı için). */
export const TURKEY_PROVINCES: { name: string; lat: number; lng: number }[] = [
  ...
  { name: 'Gümüşhane', lat: 40.4606, lng: 39.5086 },
  ...
  { name: 'Kars', lat: 40.6167, lng: 43.1 },
  ...
  { name: 'Bartın', lat: 41.5811, lng: 32.461 },
  { name: 'Ardahan', lat: 41.1105, lng: 42.7022 },
  { name: 'Iğdır', lat: 39.888, lng: 44.0048 },
